	...
	if(isset($_POST['add_event']))
	{
		...
		else
		{
			...
			else
			{
				...
				$sql_end = $db->query("INSERT INTO calendar_event (event,description,day,month,year,time_from,time_until,day_end,year_end,month_end) 
					VALUES ('$event_title','$event_desc','$day','$month','$year','$from_time','$to_time','$day_end','$year_end','$month_end')
				");
