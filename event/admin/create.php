	...
	<div id="calendar_wrap">
		<div class="title_bar">
			<div class="create_one">
				...
				<a href="index2.php" title="See Calendar" class="uibutton icon add">See Calendar</a>
		...
		<div class="list_wrapper">
			<form method="post" action="create.php">
				<div class="form">
					...
					<div class="section">
						<label for="Due On">End Date</label>
						<div>
							<input type="text" name="end_date" id="end_date" value="<?php if(isset($end_date)) { echo $end_date; } ?>"/>
						</div>
					</div>
